...
#ifndef SER_STM32MP2_PROTO_H_
#define SER_STM32MP2_PROTO_H_
...
#endif /* SER_STM32MP2_PROTO_H_ */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/devc/ser/proto.h $ $Rev: 987518 $")
#endif
